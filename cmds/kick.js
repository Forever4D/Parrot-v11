...
//////////////////////////////////////////////////////////////////////////////////////////////
          const MissingPerm = new (require('discord.js').RichEmbed)()
                .setColor("#923ce8")
                .setDescription(":parrot: Missing kick permission! "+`<a:error:${'717349340649095189'}>`)
                .setTimestamp()
                .setFooter("Enable kick permission on 'parrot' role to kick user!", 'https://cdn.discordapp.com/attachments/383674404447584256/716184356833460254/Photo_1590822019154.png'); 
  
          const MissingAuthPerm = new (require('discord.js').RichEmbed)()
                .setColor("#e8503c")
                .setDescription(":parrot: You don't have permission to kick members! "+`<a:error:${'717349340649095189'}>`)
       
         const ValidMember = new (require('discord.js').RichEmbed)()
                .setColor("#e8503c")
                .setDescription("You need to mention a member of this server to kick! :parrot:")
                .setFooter(" Example: p!kick [user] (reason) ", 'https://cdn.discordapp.com/attachments/383674404447584256/716184356833460254/Photo_1590822019154.png'); 
        
        const BanYourSelf = new (require('discord.js').RichEmbed)()
                .setColor("#e8503c")
                .setDescription(":parrot: You cannot kick yourself! "+`<a:error:${'717349340649095189'}>`)

        const EnoughRank = new (require('discord.js').RichEmbed)()
                .setColor("#e35242")
                .setDescription(":parrot: You cannot kick this member, this user have equal or higher role than you! "+`<a:error:${'717349340649095189'}>`)
...
///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (member.user.id === '239023934391975936') {
            return message.reply(`This user cannot be kicked! <a:error:${'717349340649095189'}>`)
        }
        ...
        try {
            ...
            .run(message.guild.id, member.user.id, reason || 'No Reason provided', message.author.id, "kick", caseid);
            ...
            const embed = new (require('discord.js').RichEmbed)()
                ...
                .setTimestamp()
                .setFooter(`Kick: Case-ID (${caseid})`, 'https://cdn.discordapp.com/attachments/383674404447584256/716182350844919859/Photo_1590821550863.png'); 
            await message.delete().catch(O_o=>{});
            await member.send({ embed: embed }).catch(error => null);
            await message.channel.send({ embed: embed }).catch(error => null);
            await member.kick(`${message.member.user.tag}: ${reason}`);
